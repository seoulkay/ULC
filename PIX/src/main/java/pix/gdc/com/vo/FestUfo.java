...
public class FestUfo {
	private Integer idfest_ufo;
	...
	public void setIdfest_ufo(Integer idfest_ufo) {
		this.idfest_ufo = idfest_ufo;
	}
	...
	public Date getUfo_time_stamp() {
		return ufo_time_stamp;
	}
	public void setUfo_time_stamp(Date ufo_time_stamp) {
		this.ufo_time_stamp = ufo_time_stamp;
	}
	...
	public String getUfo_survey_title() {
		return ufo_survey_title;
	}
	public void setUfo_survey_title(String ufo_survey_title) {
		this.ufo_survey_title = ufo_survey_title;
	}
	public String getUfo_survey_desc() {
		return ufo_survey_desc;
	}
	...
	public String getQr_info_title() {
		return qr_info_title;
	}
