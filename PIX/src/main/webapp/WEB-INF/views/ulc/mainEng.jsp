...
<head>
    ...
    <meta name="description" content="UFO79 platform for festival">
...
<!--                         <li><a href="#features2" class="smooth-scroll">Service</a></li> -->
            ...
            <div class="header-overlay">
                ...
                <div class="container">
                    ...
                    <div class="header-txt">
                        <h1>UFO79</h1>
                        <p>A new way to enjoy festival</p>
                    </div>
                    ...
                    <div class="header-btn">
                    	...
                    	<a href="https://www.ufo79.com/PIX/ufo/bct/stamp" class="btn-custom btn-white btn-border btn-rounded btn-icon" title="Download on Play Store"><i class="ion ion-happy-outline"></i>Bernburg City Rally</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-4"> <!-- 1 -->
                	<div class="affa-feature-icon">
                    	<div class="feature-icon-heading">
                            ...
                            <h4>Support your festivals</h4>
                        </div>
                        <p>UFO supports and manage your festivals.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-4"> <!-- 2 -->
                	<div class="affa-feature-icon">
                        ...
                        <p>Provide easy access to participants of their choice</p>
                    </div>
                </div>
                ...
                <div class="col-sm-4"> <!-- 3 -->
                	<div class="affa-feature-icon">
                    	<div class="feature-icon-heading">
                            ...
                            <p>UFO Analytics</p>
                            <h4>Report of behavior</h4>
                        </div>
                        <p>Provide in-depth insight of festivals' participants</p>
                    </div>
                </div>
            ...
            <div class="affa-form-wrap">
                ...
                <div class="pull-left">
                	<div class="pull-left post-heading-left padding-top10-lg padding-top10-md">
                        ...
                        <br>
                        <a href="https://www.ufo79.com/PIX/FEV/" class="btn-custom" ><i class="ion ion-coffee"></i> Organizer login</a>
                    </div>
                </div>
    ...
    <footer id="footer">
        ...
        <div class="container">
            ...
            <div class="footer-links">
                ...
                <a href="https://www.ufo79.com/PIX/ULC/" class="link-icon" title="Dribbble">한국어</a>
<!--                 <a href="#" class="link-icon" title="Instagram"><i class="ion ion-social-instagram"></i></a> -->
            ...
            <div class="footer-copyright">
            	<p>&copy; <a href="https://www.ufo79.com" target="_blank">UFO79 Corp.</a> All Rights Reserved.</p>
...
s1.async=true;
s1.src='https://embed.tawk.to/5950a2e150fd5105d0c82aba/default';
s1.charset='UTF-8';
