            ...
            <div style="height:2em"></div>
                    ...
                    <table class="table table_striped">
                   	...
                   	<table class="table table_striped">	
    	                ...
    	                <tr><td class="hk">부스핀<c:if test="${ufo.pin_booth ne null}"><img src="https://www.ufo79.com/image/${ufo.pin_booth}" class="img-responsive" alt="" style="width:100px"></c:if></td><td><input class="form-control" type="file" name="q5_img_file"></td></tr>
                   	</table><hr>
                   	
                   	
<%--                    	                		<tr><td class="hk">사진2<c:if test="${ufo.info_program_pic ne null}"><img src="https://www.ufo79.com/image/${ufo.info_program_pic}" class="img-responsive" alt="" style="width:100px"></c:if></td><td><input class="form-control" type="file" name="info_program_pic_file"></td></tr> --%>
...
<!--                    		<tr><td class="hk2" rowspan="3">Block 2</td> -->
<%--                    		<td class="hk">제목2</td><td><input type="text" class="form-control" name="program_title" value="${ufo.program_title }" maxlength="45"></td></tr>       --%>
