        ...
        <jsp:include page="ufoHeader.jsp" flush="true">
            ...
            <div style="height:2em"></div>
                    ...
                    <table class="table table_striped">
                   	...
                   	<table class="table table_striped">
                   		<h3>Information</h3>
                   		<!-- Grace: 메인이미지가 q3_img로 설정되어 있어요. 변경 부탁 -->
                   		...
                   		<tr><td class="hk2" rowspan="2">Block 2</td><td class="hk">제목2</td><td><input type="text" class="form-control" name="program_title" value="${ufo.program_title }" maxlength="45"></td></tr>      
                   		<tr><td class="hk">내용2</td><td><textarea form="ufoForm" class="form-control" name="info_program_text" maxlength="3000">${ufo.info_program_text }</textarea></td></tr>
                   		
                   		<tr><td class="hk2" rowspan="3">Block 3</td><td class="hk">제목3</td><td><input type="text" class="form-control" name="history_title" value="${ufo.history_title }" maxlength="45"></td></tr>
                    ...
                    <table class="table table_striped">
                   	...
                   	<%-- <table class="table table_striped">	
                   		<h3>Survey</h3>
                   		<tr><td class="hk2" rowspan="7">Questions</td><td class="hk">질문 1 <c:if test="${ufo.q1_img ne null}"><img src="https://www.ufo79.com/image/${ufo.q1_img}" class="img-responsive" alt="" style="width:100px"></c:if></td><td><input class="form-control" type="file" name="q1_img_file"></td></tr>
                   		<tr><td class="hk">q2_img <c:if test="${ufo.q1_img ne null}"><img src="https://www.ufo79.com/image/${ufo.q2_img}" class="img-responsive" alt="" style="width:100px"></c:if></td><td><input class="form-control" type="file" name="q2_img_file"></td></tr>
                   		<tr><td class="hk">q3_img <c:if test="${ufo.q1_img ne null}"><img src="https://www.ufo79.com/image/${ufo.q3_img}" class="img-responsive" alt="" style="width:100px"></c:if></td><td><input class="form-control" type="file" name="q3_img_file"></td></tr>                   	
