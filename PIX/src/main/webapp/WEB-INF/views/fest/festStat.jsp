	...
	<h3>스탬프 투어 히스토리</h3>
		<table class="table table-bordered table-hover table-condensed">
			<tr class="table table_striped">
				...
				<td class="go_img hk4"><c:if test="${ele.ufo_image ne null}"><img src="https://www.ufo79.com/image/${ele.ufo_image}" class="img-responsive" alt="" style="height:100px"></c:if></td>
