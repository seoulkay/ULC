	...
	<div class="modal-content">
	   ...
	   <div class="modal-body" style="background-color: #0081C8;">
	 	...
	 	<div style="background: url('${pageContext.request.contextPath}/resources/ufo/assets/images/stamp/bg_collage_03_500px.svg')">
			...
			<br>
		    	<a href="https://www.ufo79.com/image/${answer.q7_a}" download><span class="btn" style="background-color:WHITE; color:#0081C8; border:2px solid #0081C8"><span class="btn-text">${ufo.ufoLable.gen_save_photo}</span></span></a>
		    	<span id="shareBtn" class="btn btn-social btn-facebook" style="margin: auto;"><i class="fa fa-facebook" aria-hidden="true"></i><span class="btn-text">${ufo.ufoLable.share}</span></span>
		    <br><br>
