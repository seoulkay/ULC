...
<body>    
    ...
    <header id="header">
        ...
        <div class="header-content" >
            ...
            <!-- .header-overlay -->
            <div class="header-overlay" style="padding:0">
                
                <!-- .container -->
                <div class="container">
                    
                    <div class="header-txt">
<%--                     	<img style="max-height: 5em; margin: 0 auto" src="${pageContext.request.contextPath}/resources/tis/Atos_Pyeongchang2018_H_W_ALL.png" alt="Logo" class="img-responsive"> --%>
<!--                         <h1>Atos</h1> -->
